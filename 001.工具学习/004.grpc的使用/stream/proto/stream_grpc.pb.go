...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReplay, error) {
	out := new(HelloReplay)
	err := c.cc.Invoke(ctx, "/stream.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayHelloClientStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/stream.Greeter/SayHelloClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayHelloServerStream(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayHelloServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], "/stream.Greeter/SayHelloServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayHelloTwoWayStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloTwoWayStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], "/stream.Greeter/SayHelloTwoWayStream", opts...)
	if err != nil {
		return nil, err
	}
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stream.Greeter/SayHello",
	}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/stream/proto/stream.proto",
}
